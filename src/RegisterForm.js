...
class RegisterForm extends Component {
    ...
    formSubmit = (event) => {
        ...
        alert("Thank you for created the account!!");
        this.setState({
            fname: "",
            lname: "",
            dob: "",
    ...
    render() {
        ...
        return (
            <div className="container bg-light pb-5" style={{ textAlign: "left" }}>
                <h2 className="text-center pt-4 fw-bold">Register form</h2>
                <div className="row">
